  ...
  return (
    <section className="relative w-full h-[80vh] top-60">
      ...
      <div className="flex items-center justify-center gap-8 pt-10">
        <button className="text-white bg-[#F94819] flex items-center gap-2.5 rounded-[122px] py-4 px-8 font-normal text-[16px] leading-[120%] text-center hover:bg-[#812c12] transition-all duration-300 cursor-pointer">
          Free Consultation
        </button>
